...
* **MIDI Channel 12:** PC values 1-127 set the BPM directly to 1-127.
* **MIDI Channel 13:** Adds 100 to the PC value (e.g., PC 70 = 170 BPM).
* **MIDI Channel 14:** Adds 200 to the PC value (e.g., PC 15 = 215 BPM).
